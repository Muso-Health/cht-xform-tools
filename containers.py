...
class Container(containers.DeclarativeContainer):
    ...
    form_comparator_service = providers.Factory(FormComparatorServiceImpl, xlsform_repository=xlsform_repository)
    ...
    data_catalog_enrichment_service = providers.Factory(
        ...
        path_interpreter_factory=cht_path_interpreter.provider, 
        form_context_config=form_context_config, 
        logger=logger
    )
